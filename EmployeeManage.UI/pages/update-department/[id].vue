        ...
        <form class="mt-16" @submit.prevent="handleSubmit">
            <div class="grid gap-6 mb-6 md:grid-cols-3">
                ...
                <div>
                    ...
                    <input type="text" id="company" v-model="department.members" disabled class="bg-gray-300 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Flowbite" required>
                </div>  
            </div>
